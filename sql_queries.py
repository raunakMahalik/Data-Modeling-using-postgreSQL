...
CREATE TABLE IF NOT EXISTS songplays (songplay_id serial PRIMARY KEY, start_time time, user_id int, \
...
song_select = ("""
SELECT songs.song_id, artists.artist_id FROM songs, artists WHERE songs.title = %s \
